      ...
      <div className="w-full max-w-5xl pt-6 pb-6 flex flex-col md:flex-row">
        ...
        <div className="hidden md:flex md:w-1/2 bg-blue-200 p-6 rounded-r-4xl rounded-l-4xl mr-6">
          <div className="flex flex-col items-center w-full">
            <h2 className="text-4xl font-bold pt-10 text-black mb-4">Login as a Pharmacy</h2>
            <img src="../src/assets/4.svg" alt="pharmacy" className="w-3/4 pt-10" />
          </div>
        </div>
...
export default LoginAsPharmacy;
